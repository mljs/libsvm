...
libsvm-js-interfaces.js: js-interfaces.c svm.o libsvm/svm.h
	$(CC) $(CFLAGS) js-interfaces.c ./svm.o -o lib/libsvm-js-interfaces.js -s EXPORTED_FUNCTIONS="['_parse_command_line', '_create_svm_nodes', '_add_instance', '_libsvm_train', '_libsvm_predict_one', '_get_svr_epsilon', '_svm_free_model_content', '_svm_get_svm_type']"
