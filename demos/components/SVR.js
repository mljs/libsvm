        ...
        <div>
            ...
            <div className="row justify-content-end mt-4 mb-4">
                <div className="col-lg-7 col-xl-7 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <ControlBar vertical={true} style={{paddingLeft: 4}} help="SVM will try to fit each drawn circle with a curve. The drawn circles represent the training set. The line represents the predictions for each possible x (abscissa)."/>
                </div>
