...
extern "C"
{
	...
	struct svm_parameter *get_parameters(struct svm_model *model)
	{
		printf("gamma: %f\n", model->param.gamma);
		return &(model->param);
	}

	// int get_kernel_type(struct svm_model *model)
	// {
	// 	return model->param->kernel_type;
	// }

	// int get_svm_type(struct svm_model)
	// {
	// 	return model->param->svm_type;
	// }

	// int get_svm_degree(struct svm_model *model)
	// {
	// 	return model->param->degree;
	// }
